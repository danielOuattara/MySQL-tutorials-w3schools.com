...
--------------------------------------------------------------------------------
ALL 	                  -- Returns true if all of the subquery values meet
                        -- the condition
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
CHECK 	                -- A constraint that limits the value that can be placed
                        -- in a column
--------------------------------------------------------------------------------
COLUMN 	                -- Changes the data type of a column or deletes a column
                        -- in a table
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
NOT NULL 	              -- A constraint that enforces a column to not accept NULL
                        -- values
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
RIGHT JOIN 	            -- Returns all rows from the right table, and the matching
...
--------------------------------------------------------------------------------
TOP 	                  -- Specifies the number of records to return in the
                        -- result set
--------------------------------------------------------------------------------
TRUNCATE TABLE 	        -- Deletes the data inside a table, but not the table
                        -- itself
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
WHERE 	                -- Filters a result set to include only records that
