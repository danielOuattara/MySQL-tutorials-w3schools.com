...
--------------------------------------------------------------------------------
! 	    Represents any character not in  	  h[!oa]t : finds 'hit', but not 'hot'
        the brackets                                 and 'hat'
--------------------------------------------------------------------------------
- 	    Represents a range of characters   	c[a-b]t : finds 'cat' and 'cbt'
--------------------------------------------------------------------------------
# 	    Represents any single numeric       2#5 : finds 205, 215, 225, 235, 245,
        character                                       255, 265, 275, 285, 295
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
[] 	    Represents any single character      h[oa]t : finds 'hot', 'hat'b but
        within the brackets 	                        not 'hit'
--------------------------------------------------------------------------------
...
followed by any character, followed by "n", followed by any character,
followed by "on":
*/
SELECT * FROM Customers
...
The two following SQL statements select all customers with a City
