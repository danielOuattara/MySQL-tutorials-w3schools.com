...
CAUTION: Be careful when updating records in a table!
-------  Notice the WHERE clause in the UPDATE statement. The WHERE clause
         specifies which record(s) that should be updated.
